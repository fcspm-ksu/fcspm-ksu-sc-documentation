...
{Іванова О.В. запропонувала рекомендувати студентку 3 курсу 321 групи денної форми навчання контрактної форми фінансування Сінолуп О.Ю. (спеціальність 6.040201 <<Математика*>>, спеціалізація <<Інформатика>>) для переведення на навчання за кошти державного бюджету.

Студентка приймаює активну участь у громадському житті факультету, підтримують та збагачують його освітній та культурний рівні. Є членом факультетської команди <<Що? Де? Коли?>>.
}
{Підтримати кандидатуру студентки 321 групи Сінолуп О.Ю. для переведення на навчання за кошти державного бюджету.
