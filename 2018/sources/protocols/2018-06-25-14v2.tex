...
%\item Підтримати кандидатуру студента 1 курсу денної форми навчання напряму підготовки 121 Інженерія програмного забезпечення Валяєва К.В. для переведення на навчання за кошти державного бюджету.
%\protocolVoting{10}{0}{0}

\item[2.] Підтримати кандидатуру студентки 1 курсу денної форми навчання напряму підготовки 121 Інженерія програмного забезпечення Воропаєвої І.В. для переведення на навчання за кошти державного бюджету.
\protocolVoting{10}{0}{0}
...
\signEqualProof{25 червня 2018 р.}{Секретар студентської ради \\ факультету фізики, математики \\ та інформатики ХДУ}{Д.О. Сенчишен}
