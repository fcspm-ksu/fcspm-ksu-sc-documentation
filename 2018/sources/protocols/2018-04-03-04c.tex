...
\Attendees{
студенти денної форми навчання факультету у кількості 54 із 347 (реєстраційні листи на 4 аркушах у 1 примірнику додаються).}
...
\topic{Про пропозиції щодо поліпшення умов навчання студентів факультету.}
\end{protocolAgenda}

\protocolItem
{Ліщук Т.А. про роботу Конференції.}
{
Сенчишен Д.О. оголосив кворум Конференції: присутніх~--- 54; Конференція є правочинною.}
{
головою конференції призначити Ліщук Т.А., секретарем~--- Сенчишена~Д.О.;

провести вибори голови студентської ради факультету; голосування провести шляхом підняття руки.
}
...
\protocolItem
{Чебан В.А. про пропозиції щодо поліпшення умов навчання студентів факультету.}
{}
{присутнім делегатам Конференції анонімно висловити пропозиції щодо поліпшення умов навчання; студентській раді факультету опрацювати зібрані пропозиції та звернутися з відповідним клопотанням до декану факультету.
}

\bfseries 
\sign{Голова}{Т.А. Ліщук}
