...
%\item Підтримати кандидатуру студентки 1 курсу денної форми навчання напряму підготовки 121 Інженерія програмного забезпечення Воропаєвої І.В. для переведення на навчання за кошти державного бюджету.
%\protocolVoting{10}{0}{0}
